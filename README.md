...
- **アイコン情報の消失**：
  - 症状：アプリケーションのアイコンが正しく表示されない、またはデフォルトアイコンに戻ってしまう問題があります。
  - 原因：アプリケーションのパッケージング時にアイコンリソースが正しく埋め込まれない場合があります。
  - 影響：アプリケーションの機能には影響ありませんが、見た目が損なわれます。
  - 対処法：今後のアップデートで修正される予定です。当面はアイコンが表示されなくても機能面での問題はありませんので、そのままご利用いただけます。

- **長時間の音声分割処理中の応答性**：
  - 特に長時間（数時間以上）の録音ファイルを分割する際に、アプリケーションが一時的に応答しなくなることがあります。
  - 処理は継続しているため、完了するまでお待ちください。
  - 分割結果は処理完了後に表示されます。

その他の問題や改善要望については、GitHub上の[Issues](https://github.com/woodie2wopper/nfc-rename/issues)ページでご報告ください。